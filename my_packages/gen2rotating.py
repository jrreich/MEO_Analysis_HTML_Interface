...
def rotating0(bits):
    ...
    rotatingbin.append(["186-189 (Rotating field 32-34)", bits[32:36], "HDOP:", hdop])

    vdop = Func.getDOP(bits[36:40])
    rotatingbin.append(["190-193 (Rotating field 35-39)", bits[36:40], "VDOP:", vdop])

    ##BIT 40-41 (194-195) Automated/manual activation notification
    activation = definitions.activation_note[bits[40:42]]
    rotatingbin.append(
        [
            "194-194 (Rotating field 40-41)",
            bits[40:42],
    ...
    rotatingbin.append(
        ["199-200 (Rotating field 45-46)", bits[45:47], "GNSS location fix type:", gnss]
    )

    ##BIT 47-48 (201-202) Spare
    if Func.checkzeros(bits[47:]):
        rotatingbin.append(["201-202 (Rotating field 47-48)", bits[47:], "Spare", "OK"])
    else:
        rotatingbin.append(
            [
                "201-202 (Rotating field 47-48)",
                bits[47:],
                "Spare",
                "ERROR: Should be 00",
            ]
...
def rotating1(bits):
    ...
    rotatingbin.append(
        ["186-189 (Rotating field 32-35)", bits[32:36], "Triggering event", trigger]
    )
    ...
    if Func.checkzeros(bits[40:]):
        rotatingbin.append(["194-202 (Rotating field 40-48)", bits[40:], "Spare", "OK"])
    else:
        rotatingbin.append(
            [
                "194-202 (Rotating field 40-48)",
                bits[40:],
                "Spare",
                "ERROR: Should be 0s",
            ]
...
def rotating2(bits):
    ...
    rotatingbin.append(["159-160 (Unassigned)", bits[5:7], "Should be 00", zero])

    ##BIT 7-12 (161-166) Beacon RLS Capability
    if bits[7] == "1":
        rotatingbin.append(
            [
                "161 (Rotating field 7)",
                bits[7],
    ...
    if bits[13:16] == "001":
        ...
        rotatingbin.append(
            ["170-190 (Rotating field 16-37)", bits[16:38], "Reserved", "Reserved"]
        )

    ##BIT 38-48 (191-202) Unassigned
    if Func.checkzeros(bits[38:]):
        rotatingbin.append(
            ["192-202 (Rotating field 38-48)", bits[38:], "Unassigned", "OK"]
        )
    else:
        rotatingbin.append(
            [
                "192-202 (Rotating field 38-48)",
                bits[38:],
                "Unassigned",
...
def rotating15(bits):
    ...
    if Func.checkones(bits[5:47]):
        rotatingbin.append(["159-200 (Rotating field 5-46)", bits[5:47], "Fixed", "OK"])
    else:
        rotatingbin.append(
            [
                "159-200 (Rotating field 5-46)",
                bits[5:47],
                "Fixed",
    ...
    rotatingbin.append(
        ["201-202 (Rotating field 47-48)", bits[47:], "Method of deactivation", deact]
    )
