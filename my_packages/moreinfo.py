moreinfo = {
    ...
    "bch1": (
        "bch1",
        """<strong>21-BIT BCH CODE CALCULATION</strong><br>The BCH error-correcting code located at bits 86-106 is calculated from the first protected field of all 406 MHz messages (bits 25-85).  It is a shortened form of a (127,106) Bose-Chaudhuri-Hocquenghem (BCH) code.  
    ...
    "bch2": (
        "bch2",
        """<strong>12-BIT BCH CODE CALCULATION</strong><br>The BCH error correcting code located at bits 133-144, calculated from the second protected field of the 406Mhz message (bits 107-132), is capable 
    ...
    "natloc": (
        "natloc",
        """National location protocol identification data is provided in a nationally-defined format in 18 bits of PDF-1. 
