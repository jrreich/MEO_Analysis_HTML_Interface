...
def alertsitesol_query(sitenum, OUTPUTFOLDER, approot,servername = 'localhost', databasename = 'MccTestLGM', **kwargs):
    ...
    sql_query = ('select alertsitesolid, inputdatatype, bcnid15, framesync, '
        ...
        'longitude, a_lat, a_lon, MatchDistance, AlertMsgState, ExpectedHorzError '
            ...
            for row in outsols:  
                        if row[18]:
                            ...
                            if row[5] == 'MEOFirstAlertDOA':
                                ...
                                pnt_RCC.style.iconstyle.icon.href = 'http://maps.google.com/mapfiles/kml/pal3/icon38.png'
                                ...
                                pnt_RCC.style.iconstyle.icon.href = 'http://maps.google.com/mapfiles/kml/pal3/icon49.png'
                            elif row[5] == 'MEOUpdatedCompDOA':
                                pnt_RCC.style.iconstyle.icon.href = 'http://maps.google.com/mapfiles/kml/pal4/icon16.png'
                            else:
