...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename="C:/Users/reichj/Source/Repos/MEO_Analysis_HTML_Interface/MEOlog.txt",
                    filemode='w')
...
activate_file = r'C:\Users\reichj\Source\Repos\MEO_Analysis_HTML_Interface\env\Scripts\activate_this.py'
...
logging.basicConfig(level=logging.DEBUG,
                    format='%(asctime)s %(levelname)s %(message)s',
                    filename="C:/Users/reichj/Source/Repos/MEO_Analysis_HTML_Interface/MEOimportlog.txt",
                    filemode='w')
